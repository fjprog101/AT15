...
public class PokemonTeamTest {
    @Test
    public void theTeamPokemonShouldStartWithOnePokemon() throws IncompleteArguments {
    ...
    @Test
    public void itShouldAddAPokemonOnlyIfTheTeamHasLessThanSixPokemons() throws IncompleteArguments {
